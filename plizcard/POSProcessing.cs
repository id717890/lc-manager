...
[System.Web.Services.WebServiceBindingAttribute(Name="POSProcessingSoap", Namespace="http://loyalty.manzanagroup.ru/loyalty.xsd")]
public partial class POSProcessing : System.Web.Services.Protocols.SoapHttpClientProtocol {
    
    private System.Threading.SendOrPostCallback ProcessRequestOperationCompleted;
    
    /// <remarks/>
    public POSProcessing() {
        this.Url = "http://manzanaonline.manzanagroup.ru:8284/POSProcessing.asmx";
    }
    ...
    public ProcessRequestResponseProcessRequestResult ProcessRequest(ProcessRequestRequest request, string orgName) {
        object[] results = this.Invoke("ProcessRequest", new object[] {
                    request,
                    orgName});
        return ((ProcessRequestResponseProcessRequestResult)(results[0]));
    }
    
    /// <remarks/>
    public System.IAsyncResult BeginProcessRequest(ProcessRequestRequest request, string orgName, System.AsyncCallback callback, object asyncState) {
    ...
    /// <remarks/>
    public ProcessRequestResponseProcessRequestResult EndProcessRequest(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((ProcessRequestResponseProcessRequestResult)(results[0]));
    }
    
    /// <remarks/>
    public void ProcessRequestAsync(ProcessRequestRequest request, string orgName) {
        this.ProcessRequestAsync(request, orgName, null);
    }
    
    /// <remarks/>
    public void ProcessRequestAsync(ProcessRequestRequest request, string orgName, object userState) {
        ...
        this.InvokeAsync("ProcessRequest", new object[] {
                    request,
                    orgName}, this.ProcessRequestOperationCompleted, userState);
    }
...
public partial class ProcessRequestCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
    ...
    /// <remarks/>
    public ProcessRequestResponseProcessRequestResult Result {
        get {
            this.RaiseExceptionIfNecessary();
            return ((ProcessRequestResponseProcessRequestResult)(this.results[0]));
        }
    }
}

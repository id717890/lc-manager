namespace LC_Manager.Implementation
{
    ...
    public class JwtProvider
    {
        ...
        private static JwtProvider _provider;

        public static void Create(string tokenUri)
        {
            _tokenUri = tokenUri;
            _provider = new JwtProvider();
        }
        ...
        public ClaimsIdentity CreateIdentity(bool isAuthenticated, string userName, dynamic payload)
        {
            ...
            var test = payload.role;
            var test2 = payload.phone;
...
//            foreach (var role in roles)
            {
                jwtIdentity.AddClaim(new Claim(ClaimTypes.Role, roles));
            }

$(document).ready(function () {
	...
	if (window.location.pathname == "/") {
		...
		var weightChartVar;
        var period = $("#analytic-period").val();
	    $("#analytic-period").on("change", function () {
	        $.ajax({
	            type: "POST",
	            url: "/Home/AnalyticClientGetBuys",
	            //contentType: "application/json; charset=utf-8",
	            data: { period: this.value },
	            dataType: "json",
	            success: function (data) {
	                clientsSegmentationToBuys(data);
	            }
	        });
	        $.ajax({
	            type: "POST",
	            url: "/Home/AnalyticGetActive",
	            data: { period: this.value },
	            dataType: "json",
	            success: function (data) {
	                clientsSegmentationActive(data);
	            }
	        });
	        $.ajax({
	            type: "POST",
	            url: "/Home/AnalyticClientGetAge",
	            data: { period: this.value },
	            dataType: "json",
	            success: function (data) {
	                clientsSegmentationToAge(data);
	            }
            });
	        $.ajax({
	            type: "POST",
	            url: "/Home/AnalyticClientGetBonus",
                data: { period: this.value },
	            dataType: "json",
	            success: function (data) {
	                clientsBonusesSuccess(data);
	            }
	        });
	    });

		//сегментаци по возрасту#0
		var clientsAgeData = $.ajax({
			type: "POST",
            url: "/Home/AnalyticClientGetAge",
            data: { period: period },
			dataType: "json",
        ...
        function clientsSegmentationToAge(agedataDiagram) {
            $("#client_count_age").html(agedataDiagram.table.ClientCount);
            $("#with_birthdate").html(agedataDiagram.table.WithBirthDate + " чел.");
            $("#without_birthdate").html(agedataDiagram.table.WithoutBirthDate + " чел.");

			var configdata = agedataDiagram.graph;
			var config = {
				type: 'doughnutLabels',
				data: {
					labels: [
				...
				options: {
					...
					tooltips: {
						...
						custom: function (tooltip) {
							// Tooltip Element
							var idAftreDate = this._chart.canvas.id;
							var tooltipEl = document.getElementById('chartjs-tooltip-0');
							if (!tooltipEl) {
								tooltipEl = document.createElement('div');
								tooltipEl.id = 'chartjs-tooltip';
								tooltipEl.innerHTML = "<table></table>"
        ...
        function clientsSegmentationToBuys(buysdataDiagram) {
            $("#client_with_phone").html(buysdataDiagram.table.ClientsWithPhone + ' чел.');
            $("#client_with_email").html(buysdataDiagram.table.ClientsWithEmail + ' чел.');
            $("#client_with_ten_buys").html(buysdataDiagram.table.ClientsWithTenBuys + ' чел.');
            $("#client_with_one_buy").html(buysdataDiagram.table.ClientsWitnOneBuys + ' чел.');
            $("#client_count").html(buysdataDiagram.table.ClientQty);
            var configData = buysdataDiagram.graph;
			var config = {
				type: 'doughnut',
				data: {
					labels: [
        ...
        function clientsSegmentationActive(data) {
            $("#client_active_count").html(data.table.ClientActiveQty);
            $("#gain").html(data.table.Gain+" руб.");
            $("#avg_cheque").html(data.table.AvgCheque + " руб.");
            $("#buys_weekdays").html(data.table.BuysWeekdays + "%");
            $("#buys_weekoff").html(data.table.BuysWeekOff + "%");
            var afterData = '';
            var configdata = data.graph;
			var config = {
				type: 'doughnut',
				data: {
					labels: [
        ...
        function clientsBonusesSuccess(data) {
            $("#added_bonus").html(data.table.AddedBonus);
            $("#avg_charge").html(data.table.AvgCharge);
            $("#redeemed_bonus").html(data.table.RedeemedBonus);
            $("#avg_redeem").html(data.table.AvgRedeem);
            $("#avg_balance").html(data.table.AvgBalance);
            $("#avg_discount").html(data.table.AvgDiscount);
		...
		var clientDiagramBuys = $.ajax({
			type: "POST",
			url: "/Home/AnalyticGetDataDiagram",
			contentType: "application/json; charset=utf-8",
			dataType: "json",
			success: function (data) {
				clientDiagramMoney(data);
			}
		});

		function clientDiagramMoney(moneyData) {
			...
			var lineChartOptions = {
				...
				tooltips: {
					...
					custom: function (tooltip) {
						// Tooltip Element
						var tooltipEl = document.getElementById('chartjs-tooltip-30');
			...
			var ctx = document.getElementById("line-chart-30").getContext("2d");
		...
		//	dataType: "json",
		//	success: function (data) {
		//		shopsSegmentationAge(data);
		//	}
		//});

		//function shopsSegmentationAge(data) {
		//	var configData = data;
		//	var config = {
		//		type: 'doughnutLabels',
		//		data: {
		...
		//					// Tooltip Element
		//					var idAftreDate = this._chart.canvas.id;
		//					var tooltipEl = document.getElementById('chartjs-tooltip-4');
		//					if (!tooltipEl) {
		//						tooltipEl = document.createElement('div');
		//						tooltipEl.id = 'chartjs-tooltip';
		//						tooltipEl.innerHTML = "<table></table>"
		...
		////структура клиентской базы#2
		//var shopsActiveBuys = $.ajax({
		//	type: "POST",
		//	url: "/Home/AnalyticClientGetBuys",
		//	contentType: "application/json; charset=utf-8",
		//	dataType: "json",
		//	success: function (data) {
		//		shopsSegmentationBuys(data);
		//	}
		//});

		//function shopsSegmentationBuys(data) {
		//	var afterData = '';
		//	var configData = data;
		//	var config = {
		//		type: 'doughnut',
		...
		//					// Tooltip Element
		//					var idAftreDate = this._chart.canvas.id;
		//					var tooltipEl = document.getElementById('chartjs-tooltip-5');
		//					if (!tooltipEl) {
		//						tooltipEl = document.createElement('div');
		//						tooltipEl.id = 'chartjs-tooltip';
		//						tooltipEl.innerHTML = "<table></table>"
		...
		////line
		//var shopsDiagramBuys = $.ajax({
		//	type: "POST",
		//	url: "/Home/AnalyticGetDataDiagram",
		//	contentType: "application/json; charset=utf-8",
		//	dataType: "json",
		//	success: function (data) {
		//		shopsDiagramMoney(data);
		//	}
		//});

		//function shopsDiagramMoney(moneydata) {
		...
		//var goodsDiagramBuys = $.ajax({
		//	type: "POST",
		//	url: "/Home/AnalyticGetDataDiagram",
		//	contentType: "application/json; charset=utf-8",
		//	dataType: "json",
		//	success: function (data) {
		//		goodsDiagramMoney(data);
		//	}
		//});

		//function goodsDiagramMoney(moneyData) {
